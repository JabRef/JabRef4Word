...
// ReSharper restore RedundantOverridenMember
		...
		public void UpdateState(SelectionManager selectionManager)
		{
			...
			var canAdd = fullyEnabled && selectionManager.FieldMatches.Count == 0;
			var canEdit = fullyEnabled && selectionManager.IsSingleCitation;
			var canInsertBibliography = fullyEnabled && selectionManager.FieldMatches.Count == 0;
...
//			cbbAbout.Enabled = partlyEnabled;
		}
